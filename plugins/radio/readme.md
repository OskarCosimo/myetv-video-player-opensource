...
The API url is the JSON file with all the stream url of the radio stations, in the repository the is the file `stations_example.json` that you can use for your tests.
