...
(function () {
    ...
    class VideoLoaderPlugin {
        ...
        initUI(resolvePromise) {
            ...
            this.loaderVideo.style.cssText = 'width: 100%; height: 100%; object-fit: cover; pointer-events: none; border: none; background: transparent;';
            ...
            if (playPromise !== undefined) {
                playPromise.catch(() => {
                    if (!this.options.muted) {
                        ...
                        this.loaderVideo.play().catch(e => console.log('Loader play failed:', e));
                    }
                });
            }

            // Unblocks the queue after the timeout
            setTimeout(() => {
